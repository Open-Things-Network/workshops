...
// battery voltage measured on D9 (ADC12)
#define VBAT (analogRead(9) * 2 * 3.3 / 1024) 

// 1-wire bus on pin D0
#define ONE_WIRE_BUS 0 

// Application EUI (LSB) - put real value from TTN console!
static const u1_t PROGMEM APPEUI[8]={ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
void os_getArtEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// Device EUI (LSB) - put real value from TTN console!
static const u1_t PROGMEM DEVEUI[8]={ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// Application Key (MSB) - put real value from TTN console!
